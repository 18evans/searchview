 ...
 *
 * Unlike [SearchView], button positioning here is configured to a customisable design choice.
 * todo: add helper methods to adjust button positioning (make more generic).
 */
